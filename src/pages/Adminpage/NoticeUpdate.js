                    ...
                    <div className="Adminpage_dashboard">
                        ...
                        <div className="detail">
                            ...
                            <div className="volun_name">
                                제목 : <br />
                                <input className="notTitle" onChange={handleChange} name="title" id="title"></input><br />
                                본문 :<br />
                                <textarea className="notContent" onChange={handleChange} name="content" type='text' id="content"></textarea><br />
